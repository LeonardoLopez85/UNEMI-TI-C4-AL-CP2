...
1.  Clona este repositorio:
    ```bash
    git clone [[https://github.com/TU_USUARIO/TU_REPOSITORIO.git](https://github.com/TU_USUARIO/TU_REPOSITORIO.git](https://github.com/LeonardoLopez85/UNEMI-TI-C4-AL-CP2.git))
    ```
